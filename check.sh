...
#git clone https://github.com/catonrug/pdfcreator-detect.git && cd pdfcreator-detect && chmod +x check.sh && ./check.sh
...
link=$(echo http://download.pdfforge.org/download/pdfcreator/PDFCreator-stable?download)
...
#detect exact verison of PDFCreator
